...
public class Problem1 {
    ...
    static void processArray(int[] arr){
        ...
        //this iterates each index of the array until the very last
        for (int i = 0; i < arr.length; i++) {
            //this one divides by 2 to see if there is a remainder(odd)
            if (arr[i] % 2 != 0) {
                //this prints out which item in the array is odd using it's index location
